                    ...
                    <ul className="navbar-nav text-uppercase ml-auto">                       
                        {
                            utils.novoRequestInfo("") == null ?
                                ...
                                (   
                                    ...
                                    (
                                        utils.usuarioLogado() == "admin" ?
                                         (
                                            <React.Fragment>
                                            <li className="pure-menu-item"><Link to="/avaliacaoPatrocinadores" className="pure-menu-link">Avaliação de Patrocinadores</Link></li>
                                    ...
                                    (   
                                        <React.Fragment>
                                            ...
                                            <li className="pure-menu-item"><Link to="/historicoDoador" className="pure-menu-link">Histórico do Doador</Link></li>
                                            <li className="pure-menu-item"><Link to="/" className="pure-menu-link" onClick={utils.logout}>Sair</Link></li>
                                        </React.Fragment>
                                    )
                                )
